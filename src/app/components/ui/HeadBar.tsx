      ...
      <div className="containers flex items-center w-full justify-between px-4 md:px-6">
        <Link className="w-44 flex items-center gap-2" href="/">
          <div className="flex items-start">
            {/* <span className="text-xl font-light dark:text-rose-600">
              Syntra
            </span> */}
            <svg
              width="123.6"
        ...
        <div className="text-xs">{/* <WorldIDVerifier /> */}</div>
        {authenticated && (
          <span className="text-rose-600 font-mono text-xs">🔑</span>
        )}
